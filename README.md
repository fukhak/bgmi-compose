...
```
git clone --recurse-submodules https://git.tkmhome.com/fukhak/bgmi-compose.git
```
...
進入相關container
```
$ docker exec -it bgmi-compose_bgmi-1 bash (假如前面幾個字符沒有重複可以不用輸入完整字句)
```
